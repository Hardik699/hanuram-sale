      ...
      <div className="overflow-hidden transition-all duration-300 border border-gray-800 rounded-xl shadow-xl shadow-green-500/10 hover:shadow-green-500/20 hover:border-green-600/50 transition-all duration-300">
        ...
        <div className="p-6 sm:p-7 space-y-6 transition-colors duration-300 bg-gray-950">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="group">
              <label className="block text-sm font-bold text-cyan-400 mb-2 transition-colors duration-300 uppercase tracking-wider">
                📅 Select Year
              </label>
              <select
                value={selectedYear}
          ...
          {/* File Upload */}
          <div>
            <label className="block text-sm font-bold text-cyan-400 mb-3 transition-colors duration-300 uppercase tracking-wider">
